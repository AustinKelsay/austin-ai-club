...
- [[Sovereign AI Club - July 22, 2026]]: **GPT-5.6 ships the multi-agent runtime, not just the model**, **OpenAI Presence productizes the agent contact center**, **Closed model releases**, **Models learn to please the grader, not the user**, **OpenAI's cyber eval breached Hugging Face**, **Apple says OpenAI's hardware team took trade secrets**, and **The AI safety leaderboard tops out at C+**.
- [[Sovereign AI Club - July 8, 2026]]: **Closed model releases**.
- [[Sovereign AI Club - June 24, 2026]]: **Closed model releases**, **AI Twitter's model-release calendar slips**, **One API, many models becomes the frontier wrapper**, and **OpenAI gets its own inference chip**.
- [[Sovereign AI Club - June 10, 2026]]: **OpenAI says AI research automation is the race**.
- [[Sovereign AI Club - May 27, 2026]]: **Karpathy joins Anthropic for recursive AI research**.
- [[Sovereign AI Club - May 13, 2026]]: **Closed model releases**, **PII filters are becoming local model infrastructure**, **GPT-5.5-Cyber opens the trust gate**, and **Pentagon picks a classified AI stack**.
- [[Sovereign AI Club - April 15, 2026]]: **OpenAI acquires TBPN**, **OpenAI pauses Stargate UK**, **Two attacks on Sam Altman's home in one week**, and **Microsoft ships in-house MAI models**.
- [[Sovereign AI Club - April 1, 2026]]: **OpenAI closes new funding round**, **Sora app shutdown**, **Closed model releases**, and **OpenAI to acquire Astral**.
- [[Sovereign AI Club - March 18, 2026]]: **OpenAI WebSockets**, **Frontier lab agent frameworks**, **Claude Code + Codex updates roundup**, **Closed model releases**, and **Claude Kill?**.
