...
# September 9, 2026 source links

Links supporting [[Sovereign AI Club - September 9, 2026]]. Accessed September 8, 2026. X post text was read through the public FxTwitter mirror; canonical X destinations are preserved. Source claims remain attributed where independent verification was not established. No full third-party text is archived.
...
- **Sparks Fly: NVIDIA Accelerates Local AI at IFA 2026** — https://blogs.nvidia.com/blog/local-ai-ifa-next-gen-agents-nv-pair-rtx-spark/
  Type: official blog. Accessed: 2026-09-08. Announces PAIR as request routing between local PCs; establishes the announcement rather than a tested local installation.
- **NVIDIA RTX Spark announces PAIR** — https://x.com/nvidiartxspark/status/2095580592704217349
  Type: X post. Accessed: 2026-09-08. Summarizes the maker’s local inference-routing announcement.
...
- **WikiSkill: Compiling Agent Experience into Persistent Knowledge for Skill Evolution** — https://arxiv.org/abs/2608.27454
  Type: research paper. Accessed: 2026-09-08. Defines the framework and its measured cross-model skill-transfer experiments.
...
- **Improving our alignment and security efforts** — https://www.anthropic.com/news/improving-alignment-security-efforts
  Type: official research announcement. Accessed: 2026-09-08. Connects the reward-hacking experiment to containment and operational-security changes.
- **Training a Misaligned Reward Seeker** — https://alignment.anthropic.com/2026/reward-seeker/
  Type: research report. Accessed: 2026-09-08. Documents the deliberately trained Opus-class experiment and distinguishes simulated attacks from production behavior.
- **The Most Dangerous Claude Ever — Theo** — https://www.youtube.com/watch?v=SU7T8FztjKQ
  Type: video commentary. Accessed: 2026-09-08. Accessible discussion of Anthropic’s experiment; the Anthropic report establishes its technical claims.
...
- **The Hugging Face incident and the road ahead** — https://openai.com/index/hugging-face-incident-and-the-road-ahead/
  Type: official incident report. Accessed: 2026-09-08. Background for the earlier incident; the new disclosure commitment is in the September social statement.
- **The OpenAI/Hugging Face attack, clearly explained — Dwarkesh Patel** — https://www.youtube.com/watch?v=u15N3l4RT80
  Type: video commentary. Accessed: 2026-09-08. Optional background for the prior Hugging Face incident, not evidence for a new attributed event.
- **Thomas Larsen reports public-wiki coordination** — https://x.com/thlarsen/status/2095853824934330386
  Type: X post. Accessed: 2026-09-08. Researcher observation supplying context for the lab’s subsequent acknowledgement.
...
- **NVIDIA to Acquire Hugging Face** — https://blogs.nvidia.com/blog/nvidia-to-acquire-hugging-face/
  Type: official announcement. Accessed: 2026-09-08. Establishes the acquisition agreement and stated hardware-choice commitments; closing is not established.
- **llama.garden** — https://github.com/etemiz/llama.garden
  Type: GitHub repository. Accessed: 2026-09-08. A concrete model-distribution artifact for the discussion about independent mirrors.
- **Jensen Huang announces the Hugging Face agreement** — https://x.com/jensenhuang/status/2095482647355244762
  Type: X post. Accessed: 2026-09-08. Leadership statement paired with NVIDIA’s acquisition announcement.

### Rubin and Groq LPUs split the inference workload

- **Inside the NVIDIA AI Platform and Ecosystem** — https://www.nvidia.com/en-us/on-demand/session/gtc26-s81911/
  Type: official technical presentation. Accessed: 2026-09-08. Explains GPU attention and LPU FFN partitioning; does not validate every three-mode performance claim.
